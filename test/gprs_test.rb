...
=end
  ...
  def test_3_parse_report_bench
    ...
    Benchmark.bm(40) do |x|
      ...
      #x.report("1000000 packets (1 report 1000000 times)") do
      #  for i in 0..1000000
      #    parse_report_single(false, true)
      #  end
      #end
...
=begin
  ...
  def test_5_parse_report_c_1
    parse_report_single_c(true)
  end

  def test_6_parse_report_c_5
    parse_report_multiple_c(true)
  end
=end
